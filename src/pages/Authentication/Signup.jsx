...
function Signup() {
  return (
    <div className='h-screen p-2 mx-auto bg-white md:p-10 lg:p-5'>
        <div className="mx-auto bg-gray-100/30 border px-4 shadow-lg w-full max-w-[22rem] md:max-w-[24rem] lg:max-w-[28rem] min-h-[33rem] rounded-md">
            <img src={Logo} alt="Logo" className='flex justify-center mx-auto size-36 mt-[-2rem]'/>
            ...
            <div className="flex justify-center mt-4">
                <form className="signup-form" action="" method="POST">
                    ...
                    <input type="email" name="email" id="email" placeholder='Enter your email' className="w-full py-2 pl-2 mt-2 mb-2 text-gray-600 border rounded-md" required />
                    ...
                    <p className="pt-3 text-sm font-normal text-gray-400">Already have an account ?  <span className='text-blue-400 cursor-pointer'>Login</span> </p>
            ...
            <p className="pt-3 pb-4 text-sm font-normal text-center text-gray-400">
